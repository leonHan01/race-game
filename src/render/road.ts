...
export function ribbon(track: Track, left: number, right: number, y: number | ((lane: number) => number), material: THREE.Material, step = track.hasJumps ? 2 : 5, start = -130, end = track.length + 100) {
